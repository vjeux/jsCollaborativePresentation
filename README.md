...
I will answer comments and questions on the [Hacker News thread](https://github.com/vjeux/jsCollaborativePresentation). I will update my Twitter [@Vjeux](http://twitter.com/#!/Vjeux) with updates.
